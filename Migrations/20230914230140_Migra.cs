        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cedula = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: true),
                    NombreCliente = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    ApellidoCliente = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_idCliente", x => x.ClienteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_idProducto", x => x.ProductoID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_idVenta", x => x.VentaID);
                    table.ForeignKey(
                        name: "FK_idCliente",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_idDetalleventa", x => x.DetalleVentaID);
                    table.ForeignKey(
                        name: "FK_idProducto",
